    ...
    <section className="bg-[#f5f5f5] px-4 py-20 md:px-11">
      <div className="mx-auto max-w-[1440px]">
        ...
        <div className="mt-12 grid gap-10 lg:grid-cols-2 lg:items-center">
            ...
            <div className="mt-8 flex flex-wrap items-center gap-4">
              <div className="flex gap-3">
                <button
                  ...
                  className="flex size-11 items-center justify-center rounded-full border border-navy/15 bg-white text-navy transition hover:border-accent"
                >
                  ←
                </button>
                <button
          ...
          <article className="relative overflow-hidden rounded-3xl bg-white shadow-md lg:grid lg:grid-cols-[1fr_270px]">
            <div className="p-8 md:p-10">
              <p className="text-accent" aria-label="5 star rating">
                ★★★★★
              </p>
              <blockquote className="mt-6 text-lg leading-relaxed text-navy/80">
              ...
              <footer className="mt-8">
                <p className="font-semibold text-navy">Professor Jane Smith</p>
                <p className="text-sm text-navy/60">University of Leeds</p>
              </footer>
            </div>
            <img
